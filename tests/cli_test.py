...
class TestCLIgmcmc ( ut.TestCase ):
    ...
    def test_1afc_e ( self ):
        ...
        mcdata_ = np.array([[ 26.,  41.,  48.,  44.,  49.,  48.],
               [ 25.,  36.,  41.,  46.,  50.,  50.],
               [ 25.,  35.,  43.,  47.,  49.,  50.],
               [ 24.,  32.,  45.,  49.,  48.,  50.]])
        mcestimates_ = np.array([[  0.00000000e+00,   1.01244650e+01,   6.81000000e-03],
               [  0.00000000e+00,   1.01244650e+01,   6.81000000e-03],
               [  0.00000000e+00,   1.01244650e+01,   6.81000000e-03],
               [  0.00000000e+00,   1.01244650e+01,   6.81000000e-03]])
        mcdeviance_ = np.array([ 13.838853,  13.838853,  13.838853,  13.838853])
        ppdeviance_ = np.array([ 13.139371,   6.0274  ,   2.682062,   7.210399])
        mcthres_ = np.array([[-2.531116,  0.      ,  2.531116],
               [-2.531116,  0.      ,  2.531116],
               [-2.531116,  0.      ,  2.531116],
               [-2.531116,  0.      ,  2.531116]])
        mcslope_ = np.array([[ 0.108192,  0.107243,  0.105686],
               [ 0.108192,  0.107243,  0.105686],
               [ 0.108192,  0.107243,  0.105686],
               [ 0.108192,  0.107243,  0.105686]])
        mcRpd_ = np.array([-0.336066, -0.336066, -0.336066, -0.336066])
        ppRpd_ = np.array([-0.299707,  0.497644,  0.75994 ,  0.617216])
        mcRkd_ = np.array([-0.504366, -0.504366, -0.504366, -0.504366])
        ppRkd_ = np.array([-0.481891, -0.479417,  0.962446,  0.42972 ])
        influential_ = np.array([ 271.613986,  129.170538,  116.738175,   90.269145,   92.982437,
                 85.465553])
